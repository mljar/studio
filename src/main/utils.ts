...
export async function installCondaPackEnvironment(
  ...
  return new Promise<boolean>(async (resolve, reject) => {
    ...
    const installSteps: InstallStep[] = [
      { type: 'wheel', file: 'ai_data_scientist_magics-0.7.1-py3-none-any.whl' },
      { type: 'wheel', file: 'ai_data_scientist-0.7.1-py3-none-any.whl' },
      { type: 'wheel', file: 'pieceofcode-0.7.2-py3-none-any.whl' },
      { type: 'wheel', file: 'variable_inspector-1.0.0-py3-none-any.whl' },
